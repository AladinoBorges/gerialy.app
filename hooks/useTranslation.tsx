...
const translations = {
  'pt-BR': {
    ...
    'projects.huntly.desc': 'Atuou como Technical Lead e desenvolvedor. Criou o Motor Logístico da Huntly (HLE) com Python e FastAPI, além de gamificar e desenvolver funcionalidades de gestão financeira e de processos seletivos automatizados com IA na plataforma B2B usando React/Next.js.',
    'projects.prolicitante.desc': 'Desenvolveu o ecossistema e ferramentas para análise de editais de licitações públicas com IA, melhorando a precisão da extração de dados para mais de 99% e reduzindo o tempo de processamento de minutos para menos de 15 segundos.',
    'projects.winddigital.desc': 'Liderança técnica em RPA, Big Data e IA. Projetou pipelines de processamento massivo de dados com Pandas e Dask, liderou equipes multidisciplinares e integrou APIs de IA generativa para automação de tarefas e análise de relatórios.',
    'projects.devopness.desc': 'Trabalhou na modernização da webapp do Devopness, migrando o repositório legado de parcel + react + reach router para vite + react + tanstack router (baseado em arquivos), além de realizar melhorias de arquitetura e contribuições para os repositórios open-source.',
    // Contacts
  ...
  'pt-PT': {
    ...
    'projects.visit': 'Visitar site',
    'projects.huntly.desc': 'Atuou como Technical Lead e desenvolvedor. Criou o Motor Logístico da Huntly (HLE) com Python e FastAPI, além de gamificar e desenvolver funcionalidades de gestão financeira e de processos de seleção automatizados com IA na plataforma B2B usando React/Next.js.',
    'projects.prolicitante.desc': 'Desenvolveu o ecossistema e ferramentas para análise de editais de concursos públicos com IA, melhorando a precisão da extração de dados para mais de 99% e reduzindo o tempo de processamento de minutos para menos de 15 segundos.',
    'projects.winddigital.desc': 'Liderança técnica em RPA, Big Data e IA. Projetou pipelines de processamento massivo de dados com Pandas e Dask, liderou equipas multidisciplinares e integrou APIs de IA generativa para automação de tarefas e análise de relatórios.',
    'projects.devopness.desc': 'Trabalhou na modernização da webapp do Devopness, migrando o repositório legado de parcel + react + reach router para vite + react + tanstack router (baseado em ficheiros), além de realizar melhorias de arquitetura e contribuições para os repositórios open-source.',
    // Contacts
  ...
  'en-UK': {
    ...
    'projects.huntly.desc': 'Acted as Technical Lead and developer. Created the Huntly Logistics Engine (HLE) with Python & FastAPI, and gamified & developed financial management and AI-automated recruitment features on the B2B platform using React/Next.js.',
    'projects.prolicitante.desc': 'Developed the AI-powered ecosystem and tools for public bidding documents analysis, achieving data extraction accuracy over 99% and reducing processing times from minutes to under 15 seconds.',
    'projects.winddigital.desc': 'Tech leadership in RPA, Big Data and AI. Designed massive data pipelines using Pandas and Dask, led multidisciplinary teams, and integrated generative AI APIs for task automation and report analysis.',
    'projects.devopness.desc': "Modernised the Devopness web app, migrating the legacy parcel + react + reach router codebase to vite + react + tanstack router (file-based). Also implemented architectural improvements and contributed to the company's open-source repositories.",
    // Contacts
